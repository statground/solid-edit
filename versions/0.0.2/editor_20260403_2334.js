...
/* StatKISS 20260403 code highlight recovery patch */
(function(){
  'use strict';
  if (typeof window === 'undefined') return;
  if (window.__STATKISS_CODE_HIGHLIGHT_RECOVERY_20260403__) return;
  window.__STATKISS_CODE_HIGHLIGHT_RECOVERY_20260403__ = true;

  var PATCH_ID = 'statkiss-code-highlight-recovery-20260403-01';
  var STYLE_ID = 'statkiss-code-highlight-recovery-style';
  var SCRIPT_URL = window.STATKISS_HLJS_SCRIPT_SRC || 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.11.1/build/highlight.min.js';
  var STYLE_URL = window.STATKISS_HLJS_STYLE_HREF || 'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.11.1/build/styles/github.min.css';
  var BASE_URL = window.STATKISS_HLJS_BASE_URL || SCRIPT_URL.replace(/\/highlight(?:\.min)?\.js(?:\?.*)?$/i, '');
  var hljsPromise = null;
  var langPromiseCache = {};

  var STYLE = `
    .lre-root .lre-code-node code.hljs,
    .lre-root .lre-source-preview code.hljs,
    .lre-root .lre-code-node .hljs,
    .lre-root .lre-source-preview .hljs {
      display: block;
      background: transparent !important;
      color: inherit;
      white-space: pre;
    }
    .lre-root .lre-code-node .hljs-comment,
    .lre-root .lre-source-preview .hljs-comment,
    .lre-root .lre-code-node .hljs-quote {
      color: #64748b;
      font-style: italic;
    }
    .lre-root .lre-code-node .hljs-keyword,
    .lre-root .lre-source-preview .hljs-keyword,
    .lre-root .lre-code-node .hljs-selector-tag,
    .lre-root .lre-code-node .hljs-tag,
    .lre-root .lre-code-node .hljs-name,
    .lre-root .lre-source-preview .hljs-tag,
    .lre-root .lre-source-preview .hljs-name {
      color: #0f766e;
      font-weight: 700;
    }
    .lre-root .lre-code-node .hljs-string,
    .lre-root .lre-source-preview .hljs-string,
    .lre-root .lre-code-node .hljs-link,
    .lre-root .lre-source-preview .hljs-link,
    .lre-root .lre-code-node .hljs-regexp,
    .lre-root .lre-source-preview .hljs-regexp {
      color: #b45309;
    }
    .lre-root .lre-code-node .hljs-number,
    .lre-root .lre-source-preview .hljs-number,
    .lre-root .lre-code-node .hljs-literal,
    .lre-root .lre-source-preview .hljs-literal {
      color: #7c3aed;
    }
    .lre-root .lre-code-node .hljs-attr,
    .lre-root .lre-source-preview .hljs-attr,
    .lre-root .lre-code-node .hljs-attribute,
    .lre-root .lre-source-preview .hljs-attribute {
      color: #1d4ed8;
    }
    .lre-root .lre-code-node .hljs-title,
    .lre-root .lre-source-preview .hljs-title,
    .lre-root .lre-code-node .hljs-title.function_,
    .lre-root .lre-source-preview .hljs-title.function_,
    .lre-root .lre-code-node .hljs-function,
    .lre-root .lre-source-preview .hljs-function {
      color: #be123c;
    }
    .lre-root .lre-code-node .hljs-built_in,
    .lre-root .lre-source-preview .hljs-built_in,
    .lre-root .lre-code-node .hljs-type,
    .lre-root .lre-source-preview .hljs-type,
    .lre-root .lre-code-node .hljs-bullet,
    .lre-root .lre-source-preview .hljs-bullet {
      color: #4f46e5;
    }
    body.dark .lre-root .lre-code-node .hljs-comment,
    body.dark .lre-root .lre-source-preview .hljs-comment,
    body.dark .lre-root .lre-code-node .hljs-quote {
      color: #94a3b8;
    }
    body.dark .lre-root .lre-code-node .hljs-keyword,
    body.dark .lre-root .lre-source-preview .hljs-keyword,
    body.dark .lre-root .lre-code-node .hljs-selector-tag,
    body.dark .lre-root .lre-source-preview .hljs-selector-tag,
    body.dark .lre-root .lre-code-node .hljs-tag,
    body.dark .lre-root .lre-source-preview .hljs-tag,
    body.dark .lre-root .lre-code-node .hljs-name,
    body.dark .lre-root .lre-source-preview .hljs-name {
      color: #5eead4;
    }
    body.dark .lre-root .lre-code-node .hljs-string,
    body.dark .lre-root .lre-source-preview .hljs-string,
    body.dark .lre-root .lre-code-node .hljs-link,
    body.dark .lre-root .lre-source-preview .hljs-link,
    body.dark .lre-root .lre-code-node .hljs-regexp,
    body.dark .lre-root .lre-source-preview .hljs-regexp {
      color: #fbbf24;
    }
    body.dark .lre-root .lre-code-node .hljs-number,
    body.dark .lre-root .lre-source-preview .hljs-number,
    body.dark .lre-root .lre-code-node .hljs-literal,
    body.dark .lre-root .lre-source-preview .hljs-literal {
      color: #c4b5fd;
    }
    body.dark .lre-root .lre-code-node .hljs-attr,
    body.dark .lre-root .lre-source-preview .hljs-attr,
    body.dark .lre-root .lre-code-node .hljs-attribute,
    body.dark .lre-root .lre-source-preview .hljs-attribute {
      color: #93c5fd;
    }
    body.dark .lre-root .lre-code-node .hljs-title,
    body.dark .lre-root .lre-source-preview .hljs-title,
    body.dark .lre-root .lre-code-node .hljs-title.function_,
    body.dark .lre-root .lre-source-preview .hljs-title.function_,
    body.dark .lre-root .lre-code-node .hljs-function,
    body.dark .lre-root .lre-source-preview .hljs-function {
      color: #fda4af;
    }
    body.dark .lre-root .lre-code-node .hljs-built_in,
    body.dark .lre-root .lre-source-preview .hljs-built_in,
    body.dark .lre-root .lre-code-node .hljs-type,
    body.dark .lre-root .lre-source-preview .hljs-type,
    body.dark .lre-root .lre-code-node .hljs-bullet,
    body.dark .lre-root .lre-source-preview .hljs-bullet {
      color: #a5b4fc;
    }
  `;
  ...
  function loadScriptOnce(url, attrName){
    return new Promise(function(resolve, reject){
      ...
      var selector = 'script[' + attrName + '="' + String(url).replace(/"/g, '&quot;') + '"]';
      var existing = document.querySelector(selector);
      if (existing) {
      ...
      s.async = true;
      s.defer = true;
      s.setAttribute(attrName, url);
      s.onload = function(){ s.dataset.loaded = 'true'; resolve(s); };
      s.onerror = function(){ reject(new Error('Failed to load ' + url)); };
      document.head.appendChild(s);
    });
  }
  ...
  function ensureHljs(){
    ...
    if (window.hljs && isFn(window.hljs.highlight)) return Promise.resolve(window.hljs);
    if (hljsPromise) return hljsPromise;
    hljsPromise = loadScriptOnce(SCRIPT_URL, 'data-statkiss-hljs-src').then(function(){ return window.hljs || null; }).catch(function(){ return null; });
    return hljsPromise;
  }
  ...
  function normalizeLang(lang){
    ...
    var aliases = {
      '': 'auto', auto: 'auto', text: 'plaintext', txt: 'plaintext', plain: 'plaintext', nohighlight: 'nohighlight',
      js: 'javascript', jsx: 'javascript', mjs: 'javascript', cjs: 'javascript',
      ts: 'typescript', tsx: 'typescript', py: 'python', sh: 'bash', shell: 'bash', zsh: 'bash',
      htmlmixed: 'xml', htm: 'xml', xml: 'xml', yml: 'yaml', md: 'markdown', csharp: 'csharp', 'c#': 'csharp', 'c++': 'cpp'
    };
    return aliases.hasOwnProperty(value) ? aliases[value] : value;
  }

  function ensureLanguage(lang){
    lang = normalizeLang(lang);
    if (!lang || lang === 'auto' || lang === 'plaintext' || lang === 'nohighlight') return Promise.resolve(window.hljs || null);
    if (!window.hljs || !isFn(window.hljs.getLanguage)) return ensureHljs().then(function(){ return ensureLanguage(lang); });
    if (window.hljs.getLanguage(lang)) return Promise.resolve(window.hljs);
    if (langPromiseCache[lang]) return langPromiseCache[lang];
    var url = BASE_URL.replace(/\/$/, '') + '/languages/' + lang + '.min.js';
    langPromiseCache[lang] = loadScriptOnce(url, 'data-statkiss-hljs-lang-src').then(function(){ return window.hljs || null; }).catch(function(){ return null; });
    return langPromiseCache[lang];
  }

  function wordRegex(words){
    return new RegExp('\\b(' + words.map(function(word){ return word.replace(/[.*+?^${}()|[\\]\\]/g, '\\$&'); }).join('|') + ')\\b', 'g');
  }

  var JS_KEYWORDS = wordRegex(['as','async','await','break','case','catch','class','const','continue','debugger','default','delete','do','else','export','extends','false','finally','for','from','function','if','import','in','instanceof','let','new','null','return','super','switch','this','throw','true','try','typeof','undefined','var','void','while','with','yield']);
  ...
  function stashTokens(text, defs){
    var src = String(text || '');
    var stash = [];
    defs.forEach(function(def){
      src = src.replace(def.re, function(match){
        var key = '\uE200' + stash.length + '\uE201';
        stash.push('<span class="' + def.cls + '">' + esc(match) + '</span>');
        return key;
      });
    });
    return {
  ...
  function detectLanguage(text, requested){
    var hint = normalizeLang(requested);
    if (hint && hint !== 'auto') return hint;
    var value = String(text || '');
    if (/^\s*</.test(value) && /<\/?[A-Za-z][\w:-]*/.test(value)) return 'xml';
    if (/^\s*[\[{]/.test(value) && /:\s*/.test(value)) return 'json';
    if (/^\s*(SELECT|INSERT|UPDATE|DELETE|CREATE|ALTER|DROP)\b/i.test(value)) return 'sql';
    if (/^\s*#?!\/(?:usr\/bin\/env\s+)?(?:ba)?sh/.test(value) || /\bfi\b|\bthen\b|\becho\b/.test(value)) return 'bash';
    if (/^\s*def\s+\w+|^\s*class\s+\w+|\bimport\s+\w+/m.test(value)) return 'python';
    if (/^\s*[.#]?[\w-]+\s*\{/.test(value)) return 'css';
    if (/^\s*#{1,6}\s/m.test(value) || /^\s*[-*+]\s/m.test(value) || /```/.test(value)) return 'markdown';
    if (/\bfunction\b|\bconst\b|\blet\b|=>|console\./.test(value)) return 'javascript';
    return 'plaintext';
  }
  ...
  function highlightHtmlLike(text){
    var html = esc(text);
    html = html.replace(/(&lt;!--[\s\S]*?--&gt;)/g, '<span class="hljs-comment">$1</span>');
    html = html.replace(/(&lt;\/?)([A-Za-z][\w:-]*)/g, '$1<span class="hljs-tag"><span class="hljs-name">$2</span></span>');
    html = html.replace(/([A-Za-z_:][-A-Za-z0-9_:.]*)(=)(&quot;.*?&quot;|&#39;.*?&#39;)/g, '<span class="hljs-attr">$1</span>$2<span class="hljs-string">$3</span>');
    return html;
  }
  ...
  function highlightScriptLike(text, config){
    var defs = (config.comments || []).map(function(re){ return { re: re, cls: 'hljs-comment' }; });
    defs.push({ re: /`(?:\\[\s\S]|[^`])*`/g, cls: 'hljs-string' });
    defs.push({ re: /"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'/g, cls: 'hljs-string' });
    defs.push({ re: /\/(?![/*])(?:\\.|[^\/\\\n])+\/[dgimsuvy]*/g, cls: 'hljs-regexp' });
    var tok = stashTokens(text, defs);
    var html = esc(tok.src);
    html = html.replace(/\b(function|def|class)\s+([A-Za-z_$][\w$]*)/g, '<span class="hljs-keyword">$1</span> <span class="hljs-title function_">$2</span>');
    html = html.replace(config.keywords, '<span class="hljs-keyword">$1</span>');
    if (config.builtins) html = html.replace(config.builtins, '<span class="hljs-built_in">$1</span>');
    html = html.replace(/\b(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)\b/gi, '<span class="hljs-number">$1</span>');
    html = html.replace(/\b([A-Za-z_$][\w$]*)(?=\s*\()/g, '<span class="hljs-title function_">$1</span>');
    return tok.restore(html);
  }
  ...
  function fallbackHighlight(text, lang){
    var resolved = detectLanguage(text, lang);
    if (resolved === 'xml' || resolved === 'html') return { language: 'xml', html: highlightHtmlLike(text) };
    if (resolved === 'json') return { language: 'json', html: highlightJson(text) };
    if (resolved === 'css') return { language: 'css', html: highlightCss(text) };
    if (resolved === 'python') return { language: 'python', html: highlightScriptLike(text, { keywords: PY_KEYWORDS, comments: [/#.*$/gm], builtins: wordRegex(['print','len','range','str','int','float','list','dict','set','tuple','enumerate']) }) };
    if (resolved === 'sql') return { language: 'sql', html: highlightScriptLike(text, { keywords: SQL_KEYWORDS, comments: [/--[^\n]*/g, /\/\*[\s\S]*?\*\//g], builtins: wordRegex(['count','sum','avg','min','max']) }) };
    if (resolved === 'bash') return { language: 'bash', html: highlightScriptLike(text, { keywords: BASH_KEYWORDS, comments: [/#.*$/gm], builtins: wordRegex(['printf','echo','cd','pwd','grep','sed','awk','cat']) }) };
    if (resolved === 'markdown') return { language: 'markdown', html: highlightMarkdown(text) };
    if (resolved === 'plaintext' || resolved === 'nohighlight') return { language: 'plaintext', html: esc(text) };
    return { language: 'javascript', html: highlightScriptLike(text, { keywords: JS_KEYWORDS, comments: [/\/\*[\s\S]*?\*\//g, /\/\/[^\n]*/g], builtins: JS_BUILTINS }) };
  }
  ...
  function getSelectedCodeNode(editor){
    if (!editor) return null;
    var node = editor.selectedNode || (editor.state && (editor.state.selectedCodeFigure || editor.state.selectedCodeBlock)) || null;
    return resolveCodeNode(node);
  }

  function getCodeParts(node){
    node = resolveCodeNode(node);
    if (!node) return null;
    var pre = q(node, 'pre');
    if (!pre) {
      pre = document.createElement('pre');
    ...
    var codeEl = q(pre, 'code');
    if (!codeEl) {
      codeEl = document.createElement('code');
      pre.appendChild(codeEl);
    }
    return { node: node, pre: pre, codeEl: codeEl };
  }

  function syncChrome(parts, lang){
    var node = parts.node;
    var pre = parts.pre;
    var codeEl = parts.codeEl;
    node.dataset.language = lang;
    pre.dataset.language = lang;
    codeEl.dataset.language = lang;
    codeEl.setAttribute('spellcheck', 'false');
    codeEl.setAttribute('contenteditable', 'false');
  ...
  function tryHljs(parts, requested, text){
    var node = parts.node;
    var codeEl = parts.codeEl;
    var pre = parts.pre;
    if (!(window.hljs && isFn(window.hljs.highlight))) return false;
    var lang = normalizeLang(requested);
    try {
      if (lang === 'nohighlight') {
        codeEl.textContent = text;
        codeEl.className = 'hljs language-plaintext';
        syncChrome(parts, 'plaintext');
        return true;
      }
      if (!lang || lang === 'auto' || lang === 'plaintext') {
        var autoRes = window.hljs.highlightAuto(text || '');
        codeEl.innerHTML = autoRes && typeof autoRes.value === 'string' ? autoRes.value : esc(text);
        codeEl.className = 'hljs language-' + ((autoRes && autoRes.language) || detectLanguage(text, ''));
        syncChrome(parts, (autoRes && autoRes.language) || detectLanguage(text, ''));
        return true;
      }
      if (window.hljs.getLanguage && window.hljs.getLanguage(lang)) {
        var res = window.hljs.highlight(text || '', { language: lang, ignoreIllegals: true });
        codeEl.innerHTML = res && typeof res.value === 'string' ? res.value : esc(text);
        codeEl.className = 'hljs language-' + lang;
        syncChrome(parts, lang);
        return true;
      }
    } catch (e) {
      codeEl.textContent = text;
  ...
  function applyFallback(parts, requested, text){
    var result = fallbackHighlight(text, requested);
    parts.codeEl.innerHTML = result.html;
    parts.codeEl.className = 'hljs hljs-fallback language-' + result.language;
    syncChrome(parts, result.language);
    return result.language;
  }

  function applyHighlight(editor, node){
    var parts = getCodeParts(node);
    if (!parts) return;
    var text = String(parts.node.dataset.code != null ? parts.node.dataset.code : (parts.codeEl.dataset.rawCode != null ? parts.codeEl.dataset.rawCode : parts.codeEl.textContent || ''));
    var requested = normalizeLang(parts.node.dataset.language || parts.codeEl.dataset.language || parts.pre.dataset.language || 'auto');
    parts.node.dataset.code = text;
    parts.codeEl.dataset.rawCode = text;
    if (!tryHljs(parts, requested, text)) {
      applyFallback(parts, requested, text);
      ensureHljs().then(function(hljs){
        if (!hljs || !parts.node.isConnected) return;
        return ensureLanguage(requested);
      }).then(function(){
        if (!parts.node.isConnected) return;
        tryHljs(parts, requested, text);
      }).catch(function(){});
    }
    if (editor && isFn(editor.populateCodeInspector) && getSelectedCodeNode(editor) === parts.node) {
      try { editor.populateCodeInspector(parts.node); } catch (e) {}
    }
  }

  function highlightInside(editor, root){
    qa(root || (editor && editor.editor), '.lre-code-node').forEach(function(node){ applyHighlight(editor, node); });
  }

  function patchEditor(editor){
    if (!editor || editor.__STATKISS_CODE_HIGHLIGHT_RECOVERY_PATCHED__) return editor;
    editor.__STATKISS_CODE_HIGHLIGHT_RECOVERY_PATCHED__ = true;
    ensureStyle();
    ensureHljs().then(function(){ if (isFn(editor.highlightAllCodeBlocks)) editor.highlightAllCodeBlocks(); }).catch(function(){});
    ...
    editor.renderCodeNode = function(node){
      if (originalRenderCodeNode) originalRenderCodeNode(node);
      applyHighlight(this, node);
    };

    var originalHighlightInside = isFn(editor.highlightCodeBlocksInside) ? editor.highlightCodeBlocksInside.bind(editor) : null;
    editor.highlightCodeBlocksInside = function(root){
      if (originalHighlightInside) originalHighlightInside(root);
      highlightInside(this, root || this.editor);
    };
    editor.highlightAllCodeBlocks = function(){
      this.highlightCodeBlocksInside(this.editor);
      if (this.sourcePreview) this.highlightCodeBlocksInside(this.sourcePreview);
    };
    editor.renderAllCodeBlocks = editor.highlightAllCodeBlocks;

    var originalSaveCodeDialog = isFn(editor.saveCodeDialog) ? editor.saveCodeDialog.bind(editor) : null;
    editor.saveCodeDialog = function(){
      var result = originalSaveCodeDialog ? originalSaveCodeDialog() : undefined;
      var node = getSelectedCodeNode(this);
      if (node) applyHighlight(this, node);
      return result;
    };

    var originalRefreshSelectedCode = isFn(editor.refreshSelectedCode) ? editor.refreshSelectedCode.bind(editor) : null;
    editor.refreshSelectedCode = function(){
      var result = originalRefreshSelectedCode ? originalRefreshSelectedCode() : undefined;
      var node = getSelectedCodeNode(this);
      if (node) applyHighlight(this, node);
      return result;
    };
    ...
    var originalUpdateSelectedCodeLanguage = isFn(editor.updateSelectedCodeLanguage) ? editor.updateSelectedCodeLanguage.bind(editor) : null;
    editor.updateSelectedCodeLanguage = function(){
      var result = originalUpdateSelectedCodeLanguage ? originalUpdateSelectedCodeLanguage() : undefined;
      var node = getSelectedCodeNode(this);
      if (node) {
        if (this.codeLanguageSelect) node.dataset.language = normalizeLang(this.codeLanguageSelect.value || node.dataset.language || 'auto');
        applyHighlight(this, node);
      }
      return result;
    };
    ...
    editor.updateMarkdownPreview = function(){
      var result = originalUpdateMarkdownPreview ? originalUpdateMarkdownPreview() : undefined;
      if (this.sourcePreview) this.highlightCodeBlocksInside(this.sourcePreview);
      return result;
    };
    ...
    editor.normalizeAfterImport = function(){
      var result = originalNormalizeAfterImport ? originalNormalizeAfterImport() : undefined;
  ...
  function wrapMount(name){
    var fn = window[name];
    if (!isFn(fn) || fn.__STATKISS_CODE_HIGHLIGHT_RECOVERY_WRAP__) return;
    var wrapped = function(){
      var result = fn.apply(this, arguments);
      if (result && isFn(result.then)) return result.then(function(editor){ return patchEditor(editor); });
      return patchEditor(result);
    };
    wrapped.__STATKISS_CODE_HIGHLIGHT_RECOVERY_WRAP__ = true;
    window[name] = wrapped;
  }

  ['mountStatkissContentEditor','mountEmbeddedContentEditor','initStatkissContentEditor','initEmbeddedContentEditor','autoMountStatkissContentEditor','mountLocalRichEditor','createLocalRichEditor'].forEach(wrapMount);
  waitForEditor(patchEditor);

  function waitForEditor(callback){
    var resolve = function(){
      var editor = window.__solidAutoMountedContentEditor || window.__localRichEditor || window.localRichEditor || null;
      if (!editor) return false;
      callback(editor);
      return true;
    };
    ...
    var timer = setInterval(function(){
      tries += 1;
      if (resolve() || tries > 400) clearInterval(timer);
    }, 50);
    window.addEventListener('local-rich-editor:ready', function(){ if (resolve()) clearInterval(timer); }, { once:true });
  }
